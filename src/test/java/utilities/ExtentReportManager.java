...
public class ExtentReportManager implements ITestListener {
	...
	public void onStart(ITestContext testContext) {
		...
		sparkReporter.config().setDocumentTitle("Naukari Testing"); // Title of report
		sparkReporter.config().setReportName("Naukari Functional Testing"); // name of the report
	...
	public void onTestFailure(ITestResult result) {
		...
		try {
			...
			test.fail(MediaEntityBuilder.createScreenCaptureFromPath(imgPath).build());
